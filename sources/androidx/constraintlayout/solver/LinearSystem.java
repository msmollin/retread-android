...
public class LinearSystem {
    ...
    void displaySystemInformations() {
        ...
        System.out.println("Linear System -> Table size: " + this.TABLE_SIZE + " (" + getDisplaySize(this.TABLE_SIZE * this.TABLE_SIZE) + ") -- row sizes: " + getDisplaySize(i) + ", actual size: " + getDisplaySize(i3) + " rows: " + this.mNumRows + MqttTopic.TOPIC_LEVEL_SEPARATOR + this.mMaxRows + " cols: " + this.mNumColumns + MqttTopic.TOPIC_LEVEL_SEPARATOR + this.mMaxColumns + " 0 occupied cells, " + getDisplaySize(0));
    }
