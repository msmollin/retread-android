...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            ...
            paint.setARGB(255, TreadlyEventHelper.MESSAGE_ID_USER_GROUP_MEMBER_REQUEST_STATE_CHANGED, TreadlyEventHelper.MESSAGE_ID_USER_GROUP_MEMBER_REQUEST_STATE_CHANGED, TreadlyEventHelper.MESSAGE_ID_USER_GROUP_MEMBER_REQUEST_STATE_CHANGED);
