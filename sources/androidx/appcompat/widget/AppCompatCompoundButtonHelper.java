    ...
    */
    public void loadFromAttributes(android.util.AttributeSet r4, int r5) {
        ...
        L63:
            ...
            boolean r5 = r4.hasValue(r5)     // Catch: java.lang.Throwable -> L80
            if (r5 == 0) goto L7c
            android.widget.CompoundButton r3 = r3.mView     // Catch: java.lang.Throwable -> L80
            int r5 = androidx.appcompat.R.styleable.CompoundButton_buttonTintMode     // Catch: java.lang.Throwable -> L80
            r0 = -1
            int r5 = r4.getInt(r5, r0)     // Catch: java.lang.Throwable -> L80
            r0 = 0
            android.graphics.PorterDuff$Mode r5 = androidx.appcompat.widget.DrawableUtils.parseTintMode(r5, r0)     // Catch: java.lang.Throwable -> L80
            androidx.core.widget.CompoundButtonCompat.setButtonTintMode(r3, r5)     // Catch: java.lang.Throwable -> L80
        L7c:
            r4.recycle()
            return
        L80:
