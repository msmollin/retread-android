        ...
        public boolean perform(View view, Bundle bundle) {
            ...
            if (this.mCommand != null) {
                ...
                if (this.mViewCommandArgumentClass != null) {
                    try {
                        newInstance = this.mViewCommandArgumentClass.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
                    } catch (Exception e) {
                        e = e;
                    }
                    try {
                        ...
                        e = e2;
                        commandArguments = newInstance;
                        String name = this.mViewCommandArgumentClass == null ? "null" : this.mViewCommandArgumentClass.getName();
