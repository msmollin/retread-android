    ...
    static CentralDirectory findCentralDirectory(RandomAccessFile randomAccessFile) throws IOException, ZipException {
        ...
        do {
            ...
            if (randomAccessFile.readInt() == reverseBytes) {
                ...
                centralDirectory.size = Integer.reverseBytes(randomAccessFile.readInt()) & Movino.ONES_32;
                centralDirectory.offset = Integer.reverseBytes(randomAccessFile.readInt()) & Movino.ONES_32;
