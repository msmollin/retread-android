...
public class Explode extends Visibility {
    ...
    private void calculateOut(View view, Rect rect, int[] iArr) {
        ...
        float calculateDistance = calculateDistance(f2, f);
        float calculateMaxDistance = calculateMaxDistance(view, i - i2, centerY - i3);
        iArr[0] = Math.round((f2 / calculateDistance) * calculateMaxDistance);
        iArr[1] = Math.round(calculateMaxDistance * (f / calculateDistance));
    }
