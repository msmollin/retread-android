...
public final class ObservableZip<T, R> extends Observable<R> {
    ...
    public void subscribeActual(Observer<? super R> observer) {
        ...
        if (observableSourceArr == null) {
            ...
            for (ObservableSource<? extends T> observableSource : this.sourcesIterable) {
                if (length == observableArr.length) {
                    ...
                    System.arraycopy(observableArr, 0, observableSourceArr2, 0, length);
                    observableArr = observableSourceArr2;
                }
                observableArr[length] = observableSource;
                length++;
            }
        } else {
        ...
        if (length == 0) {
            ...
            new ZipCoordinator(observer, this.zipper, length, this.delayError).subscribe(observableArr, this.bufferSize);
        }
    }
