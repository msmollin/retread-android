...
public class GPUImageWhiteBalanceFilter extends GPUImageFilter {
    ...
    public void setTemperature(float f) {
        this.temperature = f;
        setFloat(this.temperatureLocation, (float) ((this.temperature - 5000.0d) * (this.temperature < 5000.0f ? 4.0E-4d : 6.0E-5d)));
    }

    public void setTint(float f) {
        this.tint = f;
        setFloat(this.tintLocation, (float) (this.tint / 100.0d));
    }
}
