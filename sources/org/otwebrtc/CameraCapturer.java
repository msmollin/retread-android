...
abstract class CameraCapturer implements CameraVideoCapturer {
    ...
    private int width;
    @Nullable
    private final CameraSession.CreateSessionCallback createSessionCallback = new CameraSession.CreateSessionCallback() { // from class: org.otwebrtc.CameraCapturer.1
        @Override // org.otwebrtc.CameraSession.CreateSessionCallback
    ...
    @Nullable
    private final CameraSession.Events cameraSessionEventsHandler = new CameraSession.Events() { // from class: org.otwebrtc.CameraCapturer.2
        @Override // org.otwebrtc.CameraSession.Events
    ...
    private final Runnable openCameraTimeoutRunnable = new Runnable() { // from class: org.otwebrtc.CameraCapturer.3
    ...
    public CameraCapturer(String str, @Nullable CameraVideoCapturer.CameraEventsHandler cameraEventsHandler, CameraEnumerator cameraEnumerator) {
        this.eventsHandler = cameraEventsHandler == null ? new CameraVideoCapturer.CameraEventsHandler() { // from class: org.otwebrtc.CameraCapturer.4
            @Override // org.otwebrtc.CameraVideoCapturer.CameraEventsHandler
    ...
    public void createSessionInternal(int i) {
        ...
        this.cameraThreadHandler.postDelayed(new Runnable() { // from class: org.otwebrtc.CameraCapturer.5
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void switchCameraInternal(@Nullable CameraVideoCapturer.CameraSwitchHandler cameraSwitchHandler, String str) {
        ...
        synchronized (this.stateLock) {
            if (this.switchState != SwitchState.IDLE) {
                ...
                this.cameraThreadHandler.post(new Runnable() { // from class: org.otwebrtc.CameraCapturer.9
                    @Override // java.lang.Runnable
                    public void run() {
                        cameraSession.stop();
                    }
    ...
    public void stopCapture() {
        ...
        synchronized (this.stateLock) {
            ...
            if (this.currentSession != null) {
                ...
                this.cameraStatistics = null;
                final CameraSession cameraSession = this.currentSession;
                this.cameraThreadHandler.post(new Runnable() { // from class: org.otwebrtc.CameraCapturer.6
                    @Override // java.lang.Runnable
                    public void run() {
                        cameraSession.stop();
                    }
    ...
    @Override // org.otwebrtc.CameraVideoCapturer
    public void switchCamera(final CameraVideoCapturer.CameraSwitchHandler cameraSwitchHandler) {
        Logging.d(TAG, "switchCamera");
        this.cameraThreadHandler.post(new Runnable() { // from class: org.otwebrtc.CameraCapturer.7
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void switchCamera(final CameraVideoCapturer.CameraSwitchHandler cameraSwitchHandler, final String str) {
        Logging.d(TAG, "switchCamera");
        this.cameraThreadHandler.post(new Runnable() { // from class: org.otwebrtc.CameraCapturer.8
            @Override // java.lang.Runnable
            public void run() {
