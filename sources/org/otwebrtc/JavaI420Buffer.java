...
public class JavaI420Buffer implements VideoFrame.I420Buffer {
    ...
    public static JavaI420Buffer allocate(int i, int i2) {
        ...
        return new JavaI420Buffer(i, i2, slice, i, slice2, i4, nativeAllocateByteBuffer.slice(), i4, new Runnable() { // from class: org.otwebrtc.-$$Lambda$JavaI420Buffer$s0HfT2rnQJC1_c-Yc3FrU-D8-2A
    ...
    public static VideoFrame.Buffer cropAndScaleI420(final VideoFrame.I420Buffer i420Buffer, int i, int i2, int i3, int i4, int i5, int i6) {
        if (i3 == i5 && i4 == i6) {
            ...
            return wrap(i5, i6, slice, strideY, slice2, strideU, slice3, strideV, new Runnable() { // from class: org.otwebrtc.-$$Lambda$GkpuhDjnlqht-G_fy5ZLJIKZ410
                @Override // java.lang.Runnable
                public final void run() {
    ...
    @Override // org.otwebrtc.VideoFrame.I420Buffer
