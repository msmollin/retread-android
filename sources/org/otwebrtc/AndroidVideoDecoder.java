...
public class AndroidVideoDecoder implements VideoDecoder, VideoSink {
    ...
    private Thread createOutputThread() {
        return new Thread("AndroidVideoDecoder.outputThread") { // from class: org.otwebrtc.AndroidVideoDecoder.1
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [org.otwebrtc.MediaCodecWrapper, java.lang.Thread] */
