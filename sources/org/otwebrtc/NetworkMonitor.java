...
public class NetworkMonitor {
    ...
    private NetworkMonitorAutoDetect createAutoDetect(Context context) {
        return new NetworkMonitorAutoDetect(new NetworkMonitorAutoDetect.Observer() { // from class: org.otwebrtc.NetworkMonitor.1
            @Override // org.otwebrtc.NetworkMonitorAutoDetect.Observer
