...
public final class DaggerClientComponent implements ClientComponent {
    ...
    private Observable<Boolean> getNamedObservableOfBoolean() {
        return ClientComponent_ClientModule_ProvideLocationServicesOkObservableFactory.proxyProvideLocationServicesOkObservable(this.clientModule, ClientComponent.ClientModule.provideDeviceSdk(), this.locationServicesOkObservableApi23Provider);
    }
    ...
    private void initialize(Builder builder) {
        ...
        this.provideLocationServicesOkObservableProvider = ClientComponent_ClientModule_ProvideLocationServicesOkObservableFactory.create(builder.clientModule, ClientComponent_ClientModule_ProvideDeviceSdkFactory.create(), this.locationServicesOkObservableApi23Provider);
        ...
        this.deviceComponentBuilderProvider = new Provider<DeviceComponent.Builder>() { // from class: com.polidea.rxandroidble2.DaggerClientComponent.1
