...
public class GlToneCurveFilter extends GlFilter {
    ...
    private void updateToneCurveTexture() {
        runOnDraw(new Runnable() { // from class: com.daasuu.gpuv.egl.filter.GlToneCurveFilter.1
    ...
    private ArrayList<Float> createSplineCurve(PointF[] pointFArr) {
        ...
        Arrays.sort(pointFArr2, new Comparator<PointF>() { // from class: com.daasuu.gpuv.egl.filter.GlToneCurveFilter.2
