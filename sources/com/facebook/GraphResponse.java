        ...
        try {
            try {
                try {
                    ...
                    List<GraphResponse> createResponsesFromStream = createResponsesFromStream(inputStream2, httpURLConnection, graphRequestBatch);
                    ...
                    List<GraphResponse> constructErrorResponses = constructErrorResponses(graphRequestBatch, httpURLConnection, new FacebookException(e));
                    Utility.closeQuietly(null);
                    return constructErrorResponses;
                }
            } catch (FacebookException e2) {
                Logger.log(LoggingBehavior.REQUESTS, RESPONSE_LOG_TAG, "Response <Error>: %s", e2);
                List<GraphResponse> constructErrorResponses2 = constructErrorResponses(graphRequestBatch, httpURLConnection, e2);
                Utility.closeQuietly(null);
