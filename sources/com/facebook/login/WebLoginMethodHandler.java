...
public abstract class WebLoginMethodHandler extends LoginMethodHandler {
    ...
    public Bundle getParameters(LoginClient.Request request) {
        ...
        bundle.putString(ServerProtocol.DIALOG_PARAM_IES, FacebookSdk.getAutoLogAppEventsEnabled() ? AppEventsConstants.EVENT_PARAM_VALUE_YES : AppEventsConstants.EVENT_PARAM_VALUE_NO);
        return bundle;
    }
    ...
    public Bundle addExtraParameters(Bundle bundle, LoginClient.Request request) {
        ...
        bundle.putString(ServerProtocol.DIALOG_PARAM_CUSTOM_TABS_PREFETCHING, FacebookSdk.hasCustomTabsPrefetching ? AppEventsConstants.EVENT_PARAM_VALUE_YES : AppEventsConstants.EVENT_PARAM_VALUE_NO);
        return bundle;
    }
