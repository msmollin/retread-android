...
public final class AccessToken implements Parcelable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AccessToken) {
            ...
            if (this.expires.equals(accessToken.expires) && this.permissions.equals(accessToken.permissions) && this.declinedPermissions.equals(accessToken.declinedPermissions) && this.expiredPermissions.equals(accessToken.expiredPermissions) && this.token.equals(accessToken.token) && this.source == accessToken.source && this.lastRefresh.equals(accessToken.lastRefresh) && (this.applicationId != null ? this.applicationId.equals(accessToken.applicationId) : accessToken.applicationId == null) && this.userId.equals(accessToken.userId) && this.dataAccessExpirationTime.equals(accessToken.dataAccessExpirationTime)) {
                ...
                } else if (this.graphDomain.equals(accessToken.graphDomain)) {
                    return true;
                }
            }
            return false;
    ...
    public int hashCode() {
        return ((((((((((((((((((((527 + this.expires.hashCode()) * 31) + this.permissions.hashCode()) * 31) + this.declinedPermissions.hashCode()) * 31) + this.expiredPermissions.hashCode()) * 31) + this.token.hashCode()) * 31) + this.source.hashCode()) * 31) + this.lastRefresh.hashCode()) * 31) + (this.applicationId == null ? 0 : this.applicationId.hashCode())) * 31) + this.userId.hashCode()) * 31) + this.dataAccessExpirationTime.hashCode()) * 31) + (this.graphDomain != null ? this.graphDomain.hashCode() : 0);
    }
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        if (this.graphDomain != null) {
            jSONObject.put("graph_domain", this.graphDomain);
        }
        return jSONObject;
    }
