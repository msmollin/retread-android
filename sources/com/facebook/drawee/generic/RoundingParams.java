...
public class RoundingParams {
    ...
    public int hashCode() {
        return ((((((((((((((this.mRoundingMethod != null ? this.mRoundingMethod.hashCode() : 0) * 31) + (this.mRoundAsCircle ? 1 : 0)) * 31) + (this.mCornersRadii != null ? Arrays.hashCode(this.mCornersRadii) : 0)) * 31) + this.mOverlayColor) * 31) + (this.mBorderWidth != 0.0f ? Float.floatToIntBits(this.mBorderWidth) : 0)) * 31) + this.mBorderColor) * 31) + (this.mPadding != 0.0f ? Float.floatToIntBits(this.mPadding) : 0)) * 31) + (this.mScaleDownInsideBorders ? 1 : 0);
    }
}
