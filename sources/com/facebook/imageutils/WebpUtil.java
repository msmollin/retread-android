...
public class WebpUtil {
    ...
    private static int getInt(InputStream inputStream) throws IOException {
        return ((((byte) inputStream.read()) << Message.MESSAGE_ID_EMERGENCY_STOP_REQUEST) & ViewCompat.MEASURED_STATE_MASK) | ((((byte) inputStream.read()) << Message.MESSAGE_ID_GET_DEVICE_INFO) & 16711680) | ((((byte) inputStream.read()) << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK) | (((byte) inputStream.read()) & 255);
    }
    ...
    private static int read3Bytes(InputStream inputStream) throws IOException {
        ...
        return ((getByte(inputStream) << Message.MESSAGE_ID_GET_DEVICE_INFO) & 16711680) | ((getByte(inputStream) << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK) | (b & 255);
    }
