...
public class MemberInfo {
    ...
    MemberInfo(String str, String str2, String str3, String str4, int i, boolean z) {
        this.id = str;
        this.name = str2;
        this.avatarPath = str3 == null ? "https://dgwxv5s2i5zkb.cloudfront.net/avatar/default.png" : str3;
