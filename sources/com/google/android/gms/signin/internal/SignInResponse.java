...
public class SignInResponse extends AbstractSafeParcelable {
    ...
    public SignInResponse(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) ConnectionResult connectionResult, @SafeParcelable.Param(id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zzal = i;
