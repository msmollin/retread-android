...
public final class WebImage extends AbstractSafeParcelable {
    ...
    public WebImage(JSONObject jSONObject) throws IllegalArgumentException {
        this(zza(jSONObject), jSONObject.optInt(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, 0), jSONObject.optInt(ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, 0));
    }
    ...
    public final JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.put(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, this.zzps);
            jSONObject.put(ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, this.zzpt);
        } catch (JSONException unused) {
        }
        return jSONObject;
    }
