...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add("statusCode", zza(this.zzam)).add("resolution", this.zzan).add(ShareConstants.WEB_DIALOG_PARAM_MESSAGE, this.zzao).toString();
    }
