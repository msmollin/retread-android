...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    private static final int[] EVEN_TOTAL_SUBSET = {4, 20, 52, 104, TreadlyEventHelper.MESSAGE_ID_USER_BROADCAST_STARTED};
    private static final int[] GSUM = {0, 348, 1388, 2948, 3988};
    private static final int[][] FINDER_PATTERNS = {new int[]{1, 8, 4, 1}, new int[]{3, 6, 4, 1}, new int[]{3, 4, 6, 1}, new int[]{3, 2, 8, 1}, new int[]{2, 6, 5, 1}, new int[]{2, 2, 9, 1}};
    private static final int[][] WEIGHTS = {new int[]{1, 3, 9, 27, 81, 32, 96, 77}, new int[]{20, 60, RotationOptions.ROTATE_180, 118, 143, 7, 21, 63}, new int[]{189, 145, 13, 39, 117, 140, TreadlyEventHelper.MESSAGE_ID_USER_VIDEO_PRIVATE_INVITE_DECLINED, TreadlyEventHelper.MESSAGE_ID_USER_BROADCAST_ENDED}, new int[]{193, 157, 49, 147, 19, 57, 171, 91}, new int[]{62, 186, 136, 197, 169, 85, 44, 132}, new int[]{185, 133, 188, 142, 4, 12, 36, 108}, new int[]{113, 128, 173, 97, 80, 29, 87, 50}, new int[]{150, 28, 84, 41, 123, 158, 52, 156}, new int[]{46, 138, TreadlyEventHelper.MESSAGE_ID_USER_VIDEO_PRIVATE_INVITE_REQUEST, 187, 139, TreadlyEventHelper.MESSAGE_ID_USER_FRIEND_ADDED, 196, 166}, new int[]{76, 17, 51, 153, 37, 111, 122, 155}, new int[]{43, GmsClientSupervisor.DEFAULT_BIND_FLAGS, 176, 106, 107, 110, 119, 146}, new int[]{16, 48, 144, 10, 30, 90, 59, 177}, new int[]{109, 116, 137, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, 178, 112, 125, 164}, new int[]{70, TreadlyEventHelper.MESSAGE_ID_USER_GROUP_MEMBER_REQUEST_STATE_CHANGED, 208, TreadlyEventHelper.MESSAGE_ID_USER_VIDEO_BROADCAST_INVITE_REQUEST, 184, 130, 179, 115}, new int[]{134, 191, 151, 31, 93, 68, TreadlyEventHelper.MESSAGE_ID_USER_BROADCAST_STARTED, FacebookRequestErrorClassification.EC_INVALID_TOKEN}, new int[]{148, 22, 66, 198, 172, 94, 71, 2}, new int[]{6, 18, 54, 162, 64, JfifUtil.MARKER_SOFn, 154, 40}, new int[]{120, 149, 25, 75, 14, 42, OtaUpdateInfo.urlMaxSize, 167}, new int[]{79, 26, 78, 23, 69, TreadlyEventHelper.MESSAGE_ID_USER_FRIEND_REMOVED, 199, 175}, new int[]{103, 98, 83, 38, 114, 131, 182, 124}, new int[]{161, 61, 183, 127, 170, 88, 53, 159}, new int[]{55, 165, 73, 8, 24, 72, 5, 15}, new int[]{45, 135, 194, 160, 58, 174, 100, 89}};
