...
public class FinderPatternFinder {
            ...
            while (i5 < width) {
                if (this.image.get(i5, i2)) {
                    ...
                    if (foundPatternCross(iArr)) {
                        if (handlePossibleCenter(iArr, i2, i5, z2)) {
                            if (this.hasSkipped) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:15:0x003b, code lost:
        if (r15.image.get(r17 - r6, r16 - r6) != false) goto L95;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:51:0x00b0, code lost:
        if (r15.image.get(r13, r11) != false) goto L85;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:66:0x00d8, code lost:
        if (r15.image.get(r14, r11) == false) goto L81;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:74:0x0103, code lost:
        if (java.lang.Math.abs(((((r4[0] + r4[1]) + r4[2]) + r4[3]) + r4[4]) - r19) >= (r19 * 2)) goto L80;
     */
    /* JADX WARN: Code restructure failed: missing block: B:76:0x0109, code lost:
        if (foundPatternCross(r4) == false) goto L80;
     */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x0045, code lost:
        if (r0.get(r11, r2) == false) goto L77;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:41:0x0073, code lost:
        if (r0.get(r11, r10) != false) goto L74;
     */
    ...
    */
     ...
     */
    /* JADX WARN: Code restructure failed: missing block: B:24:0x0045, code lost:
        if (r0.get(r2, r11) == false) goto L77;
     */
    /* JADX WARN: Code restructure failed: missing block: B:26:0x0049, code lost:
        if (r9[0] > r12) goto L29;
     */
     ...
     */
    /* JADX WARN: Code restructure failed: missing block: B:41:0x0073, code lost:
        if (r0.get(r10, r11) != false) goto L74;
     */
    /* JADX WARN: Code restructure failed: missing block: B:43:0x0077, code lost:
        if (r9[3] >= r12) goto L48;
     */
