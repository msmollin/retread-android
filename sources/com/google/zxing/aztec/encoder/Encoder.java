...
public final class Encoder {
    ...
    public static AztecCode encode(byte[] bArr, int i, int i2) {
        ...
        if (i2 != 0) {
            ...
            while (i9 <= 32) {
                ...
                if (size2 <= i12) {
                    ...
                    int i13 = i12 - (i12 % i10);
                    if ((!z3 || bitArray2.getSize() <= (i10 << 6)) && bitArray2.getSize() + size <= i13) {
                        i3 = i10;
                        bitArray = bitArray2;
                        z = z3;
                        i4 = i11;
        ...
        int i15 = 2;
        if (z) {
            for (int i16 = z2; i16 < iArr.length; i16++) {
                iArr[i16] = i16;
            }
            i6 = i14;
        } else {
        ...
        while (i20 < i4) {
            ...
            while (i23 < i22) {
                int i24 = i23 << 1;
                while (z2 < i15) {
                    if (generateCheckWords.get(i21 + i24 + z2)) {
                        int i25 = i20 << 1;
                        bitMatrix.set(iArr[i25 + z2], iArr[i25 + i23]);
                    }
                    if (generateCheckWords.get((i22 << 1) + i21 + i24 + z2)) {
                        int i26 = i20 << 1;
                        bitMatrix.set(iArr[i26 + i23], iArr[((i14 - 1) - i26) - z2]);
                    }
                    if (generateCheckWords.get((i22 << 2) + i21 + i24 + z2)) {
                        int i27 = (i14 - 1) - (i20 << 1);
                        bitMatrix.set(iArr[i27 - z2], iArr[i27 - i23]);
                    }
                    if (generateCheckWords.get((i22 * 6) + i21 + i24 + z2)) {
                        int i28 = i20 << 1;
                        bitMatrix.set(iArr[((i14 - 1) - i28) - i23], iArr[i28 + z2]);
                    }
                    z2++;
                    i15 = 2;
                }
