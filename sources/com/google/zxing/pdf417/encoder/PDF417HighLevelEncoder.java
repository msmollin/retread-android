...
final class PDF417HighLevelEncoder {
    ...
    private static final byte[] TEXT_MIXED_RAW = {Message.MESSAGE_ID_OTA_UPDATE, Message.MESSAGE_ID_OTA_IN_PROGRESS, Message.MESSAGE_ID_OTA_SET_MODE, Message.MESSAGE_ID_BROADCAST_DEVICE_STATUS, 52, Message.MESSAGE_ID_SET_TOTAL_STATUS, Message.MESSAGE_ID_SET_REMOTE_STATUS, Message.MESSAGE_ID_RESET_STOP, Message.MESSAGE_ID_WIFI_URL_TEST, Message.MESSAGE_ID_DEVICE_DEBUG_LOG, Message.MESSAGE_ID_SECURE_AUTHENTICATE, 13, 9, Message.MESSAGE_ID_VERIFY_MAC_ADDRESS, Message.MESSAGE_ID_DEVICE_IR_DEBUG_LOG, 35, 45, Message.MESSAGE_ID_GET_AVAILABLE_WIFI_AP_INFO, 36, Message.MESSAGE_ID_WIFI_AP_INFO, Message.MESSAGE_ID_MAC_ADDRESS, Message.MESSAGE_ID_TEST_NOTIFICATION, Message.MESSAGE_ID_SET_IR_MODE, Message.MESSAGE_ID_GET_PROFILE_ID, Message.MESSAGE_ID_CLEAR_OTA_CONFIG, 0, Message.MESSAGE_ID_BROADCAST_VALIDATE_DEVICE, 0, 0, 0};
    private static final byte[] TEXT_PUNCTUATION_RAW = {59, Message.MESSAGE_ID_LOG_USER_STATS_ENABLE, Message.MESSAGE_ID_GET_TIMESTAMP, Message.MESSAGE_ID_LOG_USER_STATS_DATA, Message.MESSAGE_ID_LOG_USER_STATS_V2_DELETE, Message.MESSAGE_ID_GET_STATUS_IOT, Message.MESSAGE_ID_GET_OTA_CONFIG, 95, 96, 126, 33, 13, 9, Message.MESSAGE_ID_VERIFY_MAC_ADDRESS, Message.MESSAGE_ID_DEVICE_IR_DEBUG_LOG, 10, 45, Message.MESSAGE_ID_GET_AVAILABLE_WIFI_AP_INFO, 36, Message.MESSAGE_ID_WIFI_AP_INFO, 34, 124, Message.MESSAGE_ID_SET_IR_MODE, Message.MESSAGE_ID_TEST_START, 41, Message.MESSAGE_ID_LOG_USER_STATS_READY, 123, 125, Message.MESSAGE_ID_SECURE_AUTHENTICATE_VERIFY, 0};
